...
public class ConstantFieldController {
	...
	public ResponseEntity<?> departFieldInsertions(@RequestBody Departments depart, Principal principal) {
		...
		if (local != null)
			return new ResponseEntity<>(new DuplicateEntryException("This Department Already exist in database", "400"),
					HttpStatus.INTERNAL_SERVER_ERROR);
		else {
	...
	public ResponseEntity<?> subDepartFieldInsertions(@RequestBody SubDepartments subDepart, Principal principal,
		...
		if (local != null)
			return new ResponseEntity<>(
					new DuplicateEntryException("This Sub-Department Already exist in database", "103"),
					HttpStatus.INTERNAL_SERVER_ERROR);
		else {
	...
	public ResponseEntity<?> clientsFieldInsertions(@RequestBody Clients clients, Principal principal) {
		...
		if (local != null) {
			...
			// database");
			return new ResponseEntity<>(new DuplicateEntryException("This Client Already exist in database", "201"),
					HttpStatus.INTERNAL_SERVER_ERROR);
		} else {
