...
public class UserServiceImpl implements UserService {
	...
	public User createUser(User user, Set<UserRole> userRole) throws Exception {
		...
		if(employee==null) {
		    throw new RecordNotFoundException("This employee with this username "+user.getUsername()+" is not exist in master table");
		}
		if(local!=null) {
			System.out.println("User already exist with this username!!");
			throw new UserAlreadinExistException("user already present with this username");
			//create user
		}
		else {
