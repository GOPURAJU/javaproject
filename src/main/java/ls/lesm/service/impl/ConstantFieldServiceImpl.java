...
public class ConstantFieldServiceImpl implements ConstantFieldService {
	...
	public EmployeeType insertEmpTypes(EmployeeType empType) {
		...
		if (local != null)
			throw new DuplicateEntryException(
					"This Employee Type with this name '" + local.getTypeName() + "' Already exist in database", "105");
		else
	...
	public OnsiteExpensesType insertExpType(OnsiteExpensesType expType, Principal principal) {
		...
		if (local != null)
			throw new DuplicateEntryException(
					"This Expense Type with this name '" + local.getExpType() + "' Already exist in database", "106");
		else
	...
	public AddressType insertAddressTyp(AddressType addType) {
		...
		if (local != null)
			throw new DuplicateEntryException(
					"This Address Type with this name '" + local.getAddType() + "' Already exist in database", "107");
		else
